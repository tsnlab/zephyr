...
/* 250ms in clocks of 750MHz */
#define BCM2712_UBUS_TIMEOUT            0xb2d0000
/* 240ms in clocks of 750MHz*/
#define BCM2712_RC_CONFIG_RETRY_TIMEOUT 0xaba0000
...
int mfd_rp1_init(const struct device *port)
{
	...
	/* Set timeouts */
	sys_write32(BCM2712_UBUS_TIMEOUT, data->cfg_addr + PCIE_MISC_UBUS_TIMEOUT);
	sys_write32(BCM2712_RC_CONFIG_RETRY_TIMEOUT,
