...
enum {
	TIMER_ERR_ALREADY_DONE = (uint32_t)VCP_DRVID_TMR,
	TIMER_ERR_SET_CLOCK = (uint32_t)VCP_DRVID_TMR + 1UL,
	TIMER_ERR_NOT_INITIALIZED = (uint32_t)VCP_DRVID_TMR + 2UL,
	TIMER_ERR_INVALID_PARAM = (uint32_t)VCP_DRVID_TMR + 3UL,
	TIMER_ERR_OUTOF_RANGE_CHANNEL = (uint32_t)VCP_DRVID_TMR + 4UL,
	TIMER_ERR_OUTOF_COMPARATOR_0 = (uint32_t)VCP_DRVID_TMR + 5UL,
	TIMER_ERR_OUTOF_COMPARATOR_1 = (uint32_t)VCP_DRVID_TMR + 6UL,
	TIMER_ERR_NOT_SUPPORT_MODE = (uint32_t)VCP_DRVID_TMR + 7UL,
	TIMER_ERR_INVALID_TIME = (uint32_t)VCP_DRVID_TMR + 8UL,
	TIMER_ERR_OUTOF_MAINCNT = (uint32_t)VCP_DRVID_TMR + 9UL
};
