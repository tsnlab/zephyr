...
struct spi_dw_data {
	...
	/* profiling */
	uint32_t prof_call_seq;
	uint64_t prof_total_us;
	uint32_t prof_total_calls;
	uint64_t prof_total_tx_bytes;
	uint64_t prof_total_rx_bytes;
	uint64_t prof_total_total_bytes;
	/* for testing */
};
...
DEFINE_MM_REG_READ(icr, DW_SPI_REG_ICR, 32)
#else
...
DEFINE_MM_REG_READ(icr, DW_SPI_REG_ICR, 8)
#endif
