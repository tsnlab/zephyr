...
#define MPU_NORM_NSHARED_WT_NWA                                                                    \
	(0x00000002U) // Outer and Inner write-through, no write-allocate non-shareable
#define MPU_NORM_SHARED_WT_NWA                                                                     \
	(0x00000006U) // Outer and Inner write-through, no write-allocate shareable

#define MPU_NORM_NSHARED_WB_NWA                                                                    \
	(0x00000003U) // Outer and Inner write-back, no write-allocate non shareable
#define MPU_NORM_SHARED_WB_NWA                                                                     \
...
typedef struct MPUConfig {
	unsigned long uiRegionEnable;
	unsigned long uiRegionBase;
	unsigned long uiRegionSize;
	unsigned long uiRegionAttr;
} MPUConfig_t;
...
*
* @param    none
* @return   unsigned long DMA Base Address.
*
* Notes
*
***************************************************************************************************
...
unsigned long MPU_GetDMABaseAddress(void);
...
*
* @param    none
* @return   unsigned long CAN Message RAM Base Address.
*
* Notes
*
***************************************************************************************************
...
unsigned long MPU_GetCANBaseAddress(void);
